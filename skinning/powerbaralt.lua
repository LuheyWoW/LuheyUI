...
local function GetDB()
    ...
    return LUICore and LUICore.db and LUICore.db.profile or {}
end
...
local function CreateQUIAltPowerBar()
    ...
    local bar = CreateFrame("StatusBar", "LuheyUI_AltPowerBar", UIParent)
...
_G.LuheyUI_RefreshPowerBarAltColors = RefreshPowerBarAltColors
...
local function CreateMover()
    ...
    powerBarMover = CreateFrame("Frame", "LuheyUI_AltPowerBarMover", UIParent, "BackdropTemplate")
...
_G.LuheyUI_TogglePowerBarAltMover = ToggleMover
