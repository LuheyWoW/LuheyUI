...
LUICore.CharacterSkinning = CharacterSkinning
...
local function GetFontPath()
    ...
    local settings = LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.character
...
local function CreateOrUpdateBackground()
    ...
    if not customBg then
        customBg = CreateFrame("Frame", "LUI_CharacterFrameBg_Skin", CharacterFrame, "BackdropTemplate")
    ...
    if PaperDollFrame then
        PaperDollFrame:HookScript("OnShow", function()
            if IsSkinningEnabled() then
                ...
                local LUICore = _G.LuheyUI and _G.LuheyUI.LUICore
                local charSettings = LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.character
...
local function SkinEquipmentManager()
    ...
    local popup = _G.LuheyUI_EquipMgrPopup
...
local function SkinTitleManagerPane()
    ...
    local popup = _G.LuheyUI_TitlesPopup
...
-- Legacy compatibility aliases (deprecated - use LUI_CharacterFrameSkinning table)
_G.LuheyUI_RefreshCharacterFrameColors = RefreshCharacterFrameColors

-- Legacy global function aliases for qui_character.lua
_G.LUI_SkinEquipmentManager = SkinEquipmentManager
_G.LUI_SkinTitleManager = SkinTitleManagerPane
_G.LUI_SetCharacterFrameBgExtended = SetCharacterFrameBgExtended
