...
local function GetGeneralFont()
    local db = LUICore.db and LUICore.db.profile and LUICore.db.profile.general
    return (db and db.font) or "Quazii"
end

local function GetDB()
    return LUICore.db and LUICore.db.profile or {}
end
...
local function CreateLootSlot(parent, index)
    ...
    local slot = CreateFrame("Button", "LUI_LootSlot"..index, parent)
...
local function CreateLootWindow()
    ...
    local frame = CreateFrame("Frame", "LUI_LootFrame", UIParent, "BackdropTemplate")
...
local function CreateRollFrame(index)
    ...
    local frame = CreateFrame("Frame", "LUI_LootRollFrame"..index, UIParent, "BackdropTemplate")
...
local function CreateRollAnchor()
    local anchor = CreateFrame("Frame", "LUI_LootRollAnchor", UIParent, "BackdropTemplate")
...
_G.LuheyUI_RefreshLootColors = function()
    if LUICore and LUICore.Loot then
        LUICore.Loot:RefreshColors()
    end
end
...
-- Initialize when LUICore is enabled
local initFrame = CreateFrame("Frame")
initFrame:RegisterEvent("PLAYER_LOGIN")
initFrame:SetScript("OnEvent", function(self, event)
    -- Defer initialization to let LUICore load first
