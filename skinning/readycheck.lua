...
_G.LuheyUI_ResetReadyCheckPosition = ResetReadyCheckPosition
...
local function CreateMover()
    ...
    readyCheckMover = CreateFrame("Frame", "LuheyUI_ReadyCheckMover", UIParent, "BackdropTemplate")
...
_G.LuheyUI_ToggleReadyCheckMover = ToggleMover
...
_G.LuheyUI_RefreshReadyCheckColors = RefreshReadyCheckColors
