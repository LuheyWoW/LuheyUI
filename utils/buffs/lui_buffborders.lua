...
local function GetSettings()
    ...
    if not LUICore.db.profile.buffBorders then
        LUICore.db.profile.buffBorders = {
            enableBuffs = true,
            enableDebuffs = true,
            hideBuffFrame = false,
    ...
    return LUICore.db.profile.buffBorders
end
...
local function ApplyFrameHiding()
    ...
    if BuffFrame then
        ...
        if not BuffFrame._LUI_ShowHooked then
            BuffFrame._LUI_ShowHooked = true
    ...
    if DebuffFrame then
        ...
        -- Hook Show() once to prevent Blizzard from re-showing
        if not DebuffFrame._LUI_ShowHooked then
            DebuffFrame._LUI_ShowHooked = true
...
_G.LuheyUI_RefreshBuffBorders = function()
