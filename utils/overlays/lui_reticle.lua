...
---------------------------------------------------------------------------
local RING_TEXTURES = {
    thin     = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_ring_thin.png",
    standard = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_ring_standard.png",
    thick    = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_ring_thick.png",
    solid    = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_ring_solid.png",
}

-- Reticle options (mix of custom texture and Blizzard Atlas)
local RETICLE_OPTIONS = {
    dot     = { path = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_reticle_dot.tga", isAtlas = false },
...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.reticle then
        cachedSettings = LUICore.db.profile.reticle
...
local function CreateReticle()
    ...
    ringFrame = CreateFrame("Frame", "LuheyUI_Reticle", UIParent)
...
---------------------------------------------------------------------------
_G.LuheyUI_RefreshReticle = function()
    InvalidateCache()
    UpdateReticle()
end
