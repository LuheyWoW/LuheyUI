...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.combatText then
        return LUICore.db.profile.combatText
    end
    return nil
end
...
local function CreateTextFrame()
    ...
    local frame = CreateFrame("Frame", "LuheyUI_CombatText", UIParent)
...
---------------------------------------------------------------------------
_G.LuheyUI_RefreshCombatText = RefreshCombatText

---------------------------------------------------------------------------
-- Global preview function for options panel
---------------------------------------------------------------------------
_G.LuheyUI_PreviewCombatText = function(message)
...
QUI.CombatText = {
    ...
    Show = ShowCombatText,
    Preview = _G.LuheyUI_PreviewCombatText,
}
