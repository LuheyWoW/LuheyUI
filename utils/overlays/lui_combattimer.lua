...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.combatTimer then
        return LUICore.db.profile.combatTimer
    end
    return nil
end
...
local function CreateTimerFrame()
    ...
    local frame = CreateFrame("Frame", "LuheyUI_CombatTimer", UIParent, "BackdropTemplate")
...
local function GetGlobalFont()
    local LUICore = _G.LuheyUI and _G.LuheyUI.LUICore
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.general and LUICore.db.profile.general.font then
        return LUICore.db.profile.general.font
    end
    return "Quazii"
end
...
---------------------------------------------------------------------------
_G.LuheyUI_RefreshCombatTimer = RefreshCombatTimer
_G.LuheyUI_ToggleCombatTimerPreview = TogglePreview
_G.LuheyUI_IsCombatTimerPreviewMode = IsPreviewMode
