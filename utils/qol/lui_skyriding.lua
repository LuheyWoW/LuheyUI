...
-- Texture paths
local DOT_TEXTURE = "Interface\\AddOns\\LuheyUI\\assets\\cursor\\lui_reticle_dot"
...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.skyriding then
        return LUICore.db.profile.skyriding
    end
    return nil
end
...
local function GetFontPath()
    ...
    return [[Interface\AddOns\LuheyUI\assets\Quazii.ttf]]
end
...
local function CreateSkyridingFrame()
    ...
    skyridingFrame = CreateFrame("Frame", "LuheyUI_Skyriding", UIParent)
    ...
    -- Apply LuheyUI font to cooldown text (deferred to ensure template is initialized)
...
---------------------------------------------------------------------------
_G.LuheyUI_RefreshSkyriding = ApplySettings
