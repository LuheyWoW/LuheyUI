...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.general then
        return LUICore.db.profile.general.quickSalvage
    end
    return nil
end
...
local SalvageButton = CreateFrame("Button", "LuheyUI_QuickSalvageButton", UIParent, table.concat(TEMPLATES, ','))
...
---------------------------------------------------------------------------
function _G.LuheyUI_RefreshQuickSalvage()
    if not InCombatLockdown() then
        SalvageButton:UpdateAttributeDriver()
    end
end
...
QuickSalvage.Refresh = _G.LuheyUI_RefreshQuickSalvage
