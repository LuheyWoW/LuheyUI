...
local function GetDB()
    ...
    if LUICore and LUICore.db and LUICore.db.profile then
        return LUICore.db.profile.rotationAssistIcon
    end
    return nil
end
...
CreateIconFrame = function()
    ...
    -- Main frame
    iconFrame = CreateFrame("Button", "LuheyUI_RotationAssistIcon", UIParent, "BackdropTemplate")
...
RefreshIconFrame = function()
    ...
    local inset = 0
    local LUICore = _G.LuheyUI and _G.LuheyUI.LUICore
    local SafeSetBackdrop = LUICore and LUICore.SafeSetBackdrop
    ...
    if db.showKeybind then
        ...
        if not fontName then
            ...
            if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.general then
                fontName = LUICore.db.profile.general.font
            end
        end
...
_G.LuheyUI_RefreshRotationAssistIcon = RefreshRotationAssistIcon
