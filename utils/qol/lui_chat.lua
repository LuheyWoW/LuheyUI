...
local function GetSettings()
    ...
    if LUICore and LUICore.db and LUICore.db.profile and LUICore.db.profile.chat then
        return LUICore.db.profile.chat
    end
    return nil
end
...
local function CreateCopyPopup()
    ...
    urlPopup = CreateFrame("Frame", "LuheyUI_ChatCopyPopup", UIParent, "BackdropTemplate")
    ...
    -- QUI color scheme
    urlPopup:SetBackdropColor(LUI_COLORS.bg[1], LUI_COLORS.bg[2], LUI_COLORS.bg[3], LUI_COLORS.bg[4])
    urlPopup:SetBackdropBorderColor(LUI_COLORS.accent[1], LUI_COLORS.accent[2], LUI_COLORS.accent[3], LUI_COLORS.accent[4])
    ...
    title:SetTextColor(LUI_COLORS.accent[1], LUI_COLORS.accent[2], LUI_COLORS.accent[3], 1)
    ...
    editBox:SetTextColor(LUI_COLORS.text[1], LUI_COLORS.text[2], LUI_COLORS.text[3], 1)
    ...
    if not tContains(UISpecialFrames, "LuheyUI_ChatCopyPopup") then
        tinsert(UISpecialFrames, "LuheyUI_ChatCopyPopup")
    end
...
local function CreateChatCopyFrame()
    ...
    chatCopyFrame = CreateFrame("Frame", "LuheyUI_ChatCopyFrame", UIParent, "BackdropTemplate")
    ...
    chatCopyFrame:SetBackdropColor(LUI_COLORS.bg[1], LUI_COLORS.bg[2], LUI_COLORS.bg[3], LUI_COLORS.bg[4])
    chatCopyFrame:SetBackdropBorderColor(LUI_COLORS.accent[1], LUI_COLORS.accent[2], LUI_COLORS.accent[3], LUI_COLORS.accent[4])
    ...
    -- Add to special frames so ESC closes it
    if not tContains(UISpecialFrames, "LuheyUI_ChatCopyFrame") then
        tinsert(UISpecialFrames, "LuheyUI_ChatCopyFrame")
    end
...
local function UpdateTabColors(tab)
    ...
    if isSelected then
        ...
        tab.__quiBackdrop:SetBackdropBorderColor(LUI_COLORS.accent[1], LUI_COLORS.accent[2], LUI_COLORS.accent[3], 1)
    else
...
---------------------------------------------------------------------------
_G.LuheyUI_RefreshChat = RefreshAll
