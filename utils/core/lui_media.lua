...
-- Register the Quazii font (used as the main UI font)
    local quaziiFontPath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii.ttf"
    LSM:Register(FONT, "Quazii", quaziiFontPath)

    -- Register Poppins fonts
    LSM:Register(FONT, "Poppins Black", "Interface\\AddOns\\LuheyUI\\assets\\Poppins-Black.ttf")
    LSM:Register(FONT, "Poppins Bold", "Interface\\AddOns\\LuheyUI\\assets\\Poppins-Bold.ttf")
    LSM:Register(FONT, "Poppins Medium", "Interface\\AddOns\\LuheyUI\\assets\\Poppins-Medium.ttf")
    LSM:Register(FONT, "Poppins SemiBold", "Interface\\AddOns\\LuheyUI\\assets\\Poppins-SemiBold.ttf")

    -- Register Expressway font
    LSM:Register(FONT, "Expressway", "Interface\\AddOns\\LuheyUI\\assets\\Expressway.TTF")

    -- Register the Quazii Logo texture
    local logoTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\luheyLogo.tga"
    LSM:Register(BACKGROUND, "QuaziiLogo", logoTexturePath)

    -- Register the Quazii texture
    local quaziiTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii.tga"
    ...
    local quaziiReverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_reverse.tga"
    ...
    local squareTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Square.tga"
    ...
    local quaziiV2TexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v2.tga"
    ...
    local quaziiV2ReverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v2reverse.tga"
    ...
    local quaziiV3TexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v3.tga"
    ...
    local quaziiV3InverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v3inverse.tga"
    ...
    local quaziiV4TexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v4.tga"
    ...
    local quaziiV4InverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v4inverse.tga"
    ...
    local quaziiV5TexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v5.tga"
    ...
    local quaziiV5InverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v5_inverse.tga"
    ...
    local quaziiV6TexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v6.tga"
    ...
    local quaziiV6InverseTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\Quazii_v6inverse.tga"
    ...
    local absorbStripeTexturePath = "Interface\\AddOns\\LuheyUI\\assets\\absorb_stripe"
    LSM:Register(STATUSBAR, "LUI Stripes", absorbStripeTexturePath)

-- Function to check if our media is registered
function LuheyUI:CheckMediaRegistration()
    ...
    if not (quaziiFontRegistered and logoTextureRegistered and quaziiTextureRegistered and quaziiReverseTextureRegistered) then
        LuheyUI:Print("Media registration failed:")
        if not quaziiFontRegistered then LuheyUI:Print("- Quazii font not registered") end
        if not logoTextureRegistered then LuheyUI:Print("- QuaziiLogo texture not registered") end
        if not quaziiTextureRegistered then LuheyUI:Print("- Quazii texture not registered") end
        if not quaziiReverseTextureRegistered then LuheyUI:Print("- Quazii Reverse texture not registered") end
    end
end

-- Register any additional fonts or textures here
-- Example:
-- LSM:Register(FONT, "MyCustomFont", "Interface\\AddOns\\LuheyUI\\assets\\mycustomfont.ttf")
-- LSM:Register(STATUSBAR, "MyCustomTexture", "Interface\\AddOns\\LuheyUI\\assets\\mycustomtexture.tga") 