---------------------------------------------------------------------------
-- LuheyUI Blizzard Options Integration
-- Registers LuheyUI in Settings > AddOns panel
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...
local QUI = LuheyUI

local ADDON_DISPLAY_NAME = "Luhey UI"

local function OpenLuheyUI()
    if QUI.GUI then
        QUI.GUI:Toggle()
        return true
    end
    print("|cFF56D1FFLuheyUI:|r GUI not loaded yet. Try /qui instead.")
    return false
end
...
local function CreateSettingsPanel()
    ...
    local panel = CreateFrame("Frame", "LuheyUI_BlizzardSettingsPanel")
